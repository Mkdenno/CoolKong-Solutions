  ...
  return (
    <>
      <section className="cx-hero-sec">
        <div className="cx-hero">
          <div className="cx-hero-l">
            <h5 style={{ color: primaryColor }}>HotelX</h5>
            <h3>Hospitality & Hotel Management Software</h3>
            <p>
              Software designed for hospitality and hotel management, to help
              you manage staff, deliver customer satisfaction, drive revenue and
      ...
      <section className="plart-sec">
        <div className="container">
          <div className="plart-t">
            ...
            <h3>HotelX Management Software Offers</h3>
            <p>
      ...
      <section className="cx-solution-sec ex">
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>About HotelX</h5>
            <h3>The Complete Hotel Tech Solution</h3>
            <p>
              Improve your hotel and resort guest experience and maximise your
              profits with a smart cloud-based property management software from
              any device.
            </p>
          </div>
          ...
          <div className="plart-b">
            ...
            <div className="plart-b-right">
              <img src="/images/about-hx.svg" alt="prod" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cx-business-sec">
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>
              All Restaurants Can Use HotelX
            </h5>
      ...
      <section className="cx-collaborate-sec">
        ...
        >
          ...
          <h3>Hotel Management Software preferred by Hoteliers</h3>
      ...
      <section className="cx-competition-sec">
        <div className="container">
          <div className="plart-t">
            ...
            <p>
              HotelX white-label banking software comes as a collection of
        ...
        <div className="container">
          ...
          <div className="schedules">
            <div className="sched-desc">
              <h5>HotelX Hotel Reservation & Menu Ordering App</h5>
              <p>
          ...
          <div className="schedules">
            <div className="sched-desc">
              <h5>HotelX Hotel Reservation & Menu Ordering Website</h5>
              <p>
                Vorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate libero et velit interdum, ac aliquet odio mattis.
                Class aptent taciti sociosqu ad litora torquent per conubia
          ...
          <div className="schedules">
            <div className="sched-desc">
              <h5>HotelX Management Solution</h5>
              <p>
                Vorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate libero et velit interdum, ac aliquet odio mattis.
                Class aptent taciti sociosqu ad litora torquent per conubia
      ...
      <section className="cx-sell-sec">
        <div className="container sec-6">
          <div className="sec-6-r cloud">
            ...
            <h3>Start Innovating Today Experience HotelX for Yourself.</h3>
            <p>
      ...
      <section className="cx-collaborate-sec">
        ...
        >
          <h3>
            No Matter What Your Hospitality Business, We Have A Solution To Suit
            Your Needs
          </h3>
