  ...
  return (
    <>
      <section className="cx-hero-sec">
        <div className="cx-hero">
          <div className="cx-hero-l">
            <h5 style={{ color: primaryColor }}>ThriftX</h5>
            <h3>
              Thrift Collection & Investment Management Software for Your Thrift
              Banking
            </h3>
            <p>
        ...
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>
              Many Challenges, One Investment Solution.
            </h5>
            <h3>Investment management software for your needs </h3>
            <p>
              Thriftx is a highly customizable online food ordering and delivery
      ...
      <section className="cx-solution-sec ex">
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>About ThriftX</h5>
            <h3>You Can Manage Your Assests With ThriftX</h3>
            <p>
          ...
          <div className="plart-b">
            <div className="plart-b-left">
              <h3>Data to Power Unparalleled Flexibility</h3>
            ...
            <div className="plart-b-right">
              <img src="/images/abouth-thx.svg" alt="prod" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cx-business-sec">
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>
              All Types of Business can Use ThriftX
            </h5>
            <h3>A Platform Built to Simplify Complexity</h3>
            <p>
              Different asset classes require different solutions. ThriftX is
      ...
      <section className="cx-collaborate-sec">
        ...
        >
          ...
          <h3>Choose ThriftX today so you can scale your tomorrow.</h3>
        ...
        <div className="container">
          ...
          <div className="schedules">
            <div className="sched-desc">
              <h5>Digital Thrift Collection App </h5>
              <p>
          ...
          <div className="schedules">
            <div className="sched-desc">
              <h5>Investment Management App</h5>
              <p>
                Vorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                vulputate libero et velit interdum, ac aliquet odio mattis.
                Class aptent taciti sociosqu ad litora torquent per conubia
      ...
      <section className="cx-sell-sec">
        <div className="container sec-6">
          <div className="sec-6-r cloud">
            ...
            <h3>Empower your Clients and business with Thriftx</h3>
            <p>
