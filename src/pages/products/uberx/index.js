  ...
  return (
    <>
      <section className="cx-hero-sec">
        <div className="cx-hero">
          <div className="cx-hero-l">
            <h5 style={{ color: primaryColor }}>UberX</h5>
            <h3>Uber Clone - Best Ride-hailing App Software</h3>
            <p>
              Power up your transport business with UberX Ride-hailing dispatch
              software. UberX can help effectively manage your business and
              makes every operation streamlined.
            </p>
          ...
          <div className="cx-hero-r">
            <img src="./images/uberx.svg" alt="hero" />
          </div>
        </div>
      </section>
      <PartnerImg
        ...
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>
              Many Customers, One Booking Solution.
            </h5>
            <h3>Uberx Ride-Hailing Software Offers</h3>
            <p>
      ...
      <section className="cx-solution-sec ex">
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>About UberX</h5>
            <h3>Steller Features For You, Cab drivers and Users</h3>
            <p>
              Our on-demand Uber Clone App – For Ride-hailing Offers Unique
              Features Against Your Competitors
            </p>
          </div>
          ...
          <div className="plart-b">
            ...
            <div className="plart-b-right">
              <img src="/images/about-ux.svg" alt="prod" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cx-business-sec">
        <div className="container">
          <div className="plart-t">
            <h5 style={{ color: primaryColor }}>
              All Ride-hailing Companies Can Use UberX
            </h5>
            <h3>Welcome To The New Way Of Booking Rides.</h3>
            <p>
        ...
        <div className="container">
          ...
          <div className="schedules">
            <div className="sched-desc">
              <h5>UberX Ride-sharing & Taxi Hailing App</h5>
              <p>
      ...
      <section className="cx-sell-sec">
        <div className="container sec-6">
          <div className="sec-6-r cloud">
            ...
            <h3>Empower your Clients and business with UberX</h3>
            <p>
